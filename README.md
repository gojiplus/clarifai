...
To learn about how to use clarifai, see [using_clarifai](vignettes/using_clarifai.Rmd) or [analyzing instagram accounts of politicians](vignettes/poligrams.Rmd).
